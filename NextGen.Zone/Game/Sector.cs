...
namespace NextGen.Zone.Game
{
	public sealed class Sector
	{
		...
		public Dictionary<ushort, MapObject> Objects { get { return objects ?? (objects = new Dictionary<ushort, MapObject>()); } }

		private Dictionary<ushort, Drop> drops;
		public Dictionary<ushort, Drop> Drops { get { return drops ?? (drops= new Dictionary<ushort, Drop>()); } }
