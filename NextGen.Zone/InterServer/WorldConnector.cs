...
namespace NextGen.Zone.InterServer
{
    ...
    public sealed class WorldConnector : AbstractConnector
    {
        ...
        public static bool Load(string ip, int port)
        {
            ...
            catch (Exception ex) { Log.WriteLine(LogLevel.Exception, "Fehler beim Verbindungsaufbau zum World-Server: {0}", ex); return false; }
        }
