...
public sealed class WorldManager {
    ...
    public ConcurrentDictionary<byte, WorldConnection> Worlds {
        get;
        private set;
    }
    public ConcurrentBag<int> InterServerConnections {
        get;
        private set;
    }
    ...
    public WorldManager() {
        ...
        updater.Elapsed += new ElapsedEventHandler(update_world_status);
        updater.Start();
    }
